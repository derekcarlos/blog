...
> [!NOTE]
> Around 5-6 minutes after performing steps 4 and 5, the trail file size has increased. The state of the Extract in `GV$GOLDENGATE_CAPTURE` moved to `WAITING FOR TRANSACTION`
