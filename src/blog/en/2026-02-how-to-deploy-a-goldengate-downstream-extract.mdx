...
> [!NOTE]
> Around 5-6 minutes after performing steps 7 and 8, the trail file size has increased. The state of the Extract in `GV$GOLDENGATE_CAPTURE` moved to `WAITING FOR TRANSACTION`
